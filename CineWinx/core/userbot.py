    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                LOGGER(__name__).error(
                    f"Assistant Account 1 has failed to access the log Group. Make sure that you have added your "
                    f"assistant to your log group and promoted as admin!"
                )
                sys.exit()
        ...
        if config.STRING2:
            ...
            try:
                ...
                LOGGER(__name__).error(
                    f"Assistant Account 2 has failed to access the log Group. Make sure that you have added your "
                    f"assistant to your log group and promoted as admin!"
                )
                # sys.exit()
        ...
        if config.STRING3:
            ...
            try:
                ...
                LOGGER(__name__).error(
                    f"Assistant Account 3 has failed to access the log Group. Make sure that you have added your "
                    f"assistant to your log group and promoted as admin!"
                )
                sys.exit()
        ...
        if config.STRING4:
            ...
            try:
                ...
                LOGGER(__name__).error(
                    f"Assistant Account 4 has failed to access the log Group. Make sure that you have added your "
                    f"assistant to your log group and promoted as admin!"
                )
                sys.exit()
        ...
        if config.STRING5:
            ...
            try:
                ...
                LOGGER(__name__).error(
                    f"Assistant Account 5 has failed to access the log Group. Make sure that you have added your "
                    f"assistant to your log group and promoted as admin!"
                )
                sys.exit()
