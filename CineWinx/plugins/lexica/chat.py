...
<b>🔖 𝗖𝗼𝗺𝗮𝗻𝗱𝗼𝘀:</b>
• <code>/llm</code> <i>prompt</i>: 📝 𝗚𝗲𝗿𝗲 𝘁𝗲𝘅𝘁𝗼 𝗰𝗼𝗺 𝗯𝗮𝘀𝗲 𝗻𝗼 𝗽𝗿𝗼𝗺𝗽𝘁 𝗳𝗼𝗿𝗻𝗲𝗰𝗶𝗱𝗼.
• <code>/llmgen</code> <i>prompt</i>: 📝 𝗚𝗲𝗿𝗲 𝘁𝗲𝘅𝘁𝗼 𝗰𝗼𝗺 𝗯𝗮𝘀𝗲 𝗻𝗼 𝗽𝗿𝗼𝗺𝗽𝘁 𝗳𝗼𝗿𝗻𝗲𝗰𝗶𝗱𝗼.
• <code>/llmgenerate</code> <i>prompt</i>: 📝 𝗚𝗲𝗿𝗲 𝘁𝗲𝘅𝘁𝗼 𝗰𝗼𝗺 𝗯𝗮𝘀𝗲 𝗻𝗼 𝗽𝗿𝗼𝗺𝗽𝘁 𝗳𝗼𝗿𝗻𝗲𝗰𝗶𝗱𝗼.
• <code>/llma</code> <i>prompt</i>: 📝 𝗚𝗲𝗿𝗲 𝘁𝗲𝘅𝘁𝗼 𝗰𝗼𝗺 𝗯𝗮𝘀𝗲 𝗻𝗼 𝗽𝗿𝗼𝗺𝗽𝘁 𝗳𝗼𝗿𝗻𝗲𝗰𝗶𝗱𝗼.

<b>💡 𝗘𝘅𝗲𝗺𝗽𝗹𝗼𝘀:</b>
• <code>/llm O que é a vida?</code>
• <code>/llmgenerate Como fazer um bolo?</code>
• <code>/llmgen O que é a vida?</code>
• <code>/llma Como fazer um bolo?</code>
"""
