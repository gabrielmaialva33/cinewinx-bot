...
from CineWinx import HELPABLE, app
from CineWinx.utils.database import get_lang, is_commanddelete_on
from CineWinx.utils.decorators.language import language_start
from CineWinx.utils.inline.help import private_help_panel
...
@language_start
async def help_com_group(_client: app, message: Message, _):
...
async def help_button(client: app, query: CallbackQuery):
    ...
    if mod_match:
        ...
        key = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text="↪️ Voltar", callback_data=f"help_back({prev_page_num})"
                    ),
