...
QUOTE_COMMAND = get_command("QUOTE_COMMAND")
...
# ---------------------------------------------------------------------------------------------------
async def pyrogram_to_quotly(messages: list, is_reply: bool = False):
...
# ---------------------------------------------------------------------------------------------------
@app.on_message(filters.command(QUOTE_COMMAND, PREFIXES) & filters.reply)
async def msg_quotly_cmd(self: Client, ctx: Message):
    is_reply = False
    if ctx.command[0].endswith("r"):
        is_reply = True
    if len(ctx.text.split()) > 1:
        check_arg = is_arg_int(ctx.command[1])
        if check_arg[0]:
            if check_arg[1] < 2 or check_arg[1] > 10:
                return await ctx.reply_text("𝗔𝗹𝗰𝗮𝗻𝗰𝗲 𝗶𝗻𝘃á𝗹𝗶𝗱𝗼 ❌")
            try:
                messages = [
                    i
            ...
            try:
                ...
                bio_sticker.name = "cinewinx_sticker.webp"
...
__MODULE__ = "🎭 𝗤𝘂𝗼𝘁𝗲"
__HELP__ = """
<b>🎭 𝗔𝗷𝘂𝗱𝗮 𝗱𝗼 𝗖𝗼𝗺𝗮𝗻𝗱𝗼 𝗤𝘂𝗼𝘁𝗹𝘆:</b>

<b>📝 𝗗𝗲𝘀𝗰𝗿𝗶𝗰̧𝗮̃𝗼:</b>

𝗘𝘀𝘁𝗲 𝗰𝗼𝗺𝗮𝗻𝗱𝗼 𝗴𝗲𝗿𝗮 𝘂𝗺𝗮 𝗰𝗶𝘁𝗮çã𝗼 𝗲𝘀𝘁𝗶𝗹𝗶𝘇𝗮𝗱𝗮 𝗮 𝗽𝗮𝗿𝘁𝗶𝗿 𝗱𝗲 𝘂𝗺𝗮 𝗺𝗲𝗻𝘀𝗮𝗴𝗲𝗺 𝗼𝘂 𝗱𝗲 𝘂𝗺𝗮 𝗳𝗮𝗶𝘅𝗮 𝗱𝗲 𝗺𝗲𝗻𝘀𝗮𝗴𝗲𝗻𝘀. ✍️

<b>🔧 𝗨𝘀𝗼:</b>

• /q - 𝗚𝗲𝗿𝗮 𝘂𝗺𝗮 𝗰𝗶𝘁𝗮𝗰̧𝗮̃𝗼 𝗱𝗮 𝗺𝗲𝗻𝘀𝗮𝗴𝗲𝗺 𝗿𝗲𝘀𝗽𝗼𝗻𝗱𝗶𝗱𝗮.
• /r - 𝗚𝗲𝗿𝗮 𝘂𝗺𝗮 𝗰𝗶𝘁𝗮𝗰̧𝗮̃𝗼 𝗱𝗲 𝘂𝗺𝗮 𝗳𝗮𝗶𝘅𝗮 𝗱𝗲 𝗺𝗲𝗻𝘀𝗮𝗴𝗲𝗻𝘀.

<b>📝 𝗗𝗲𝘁𝗮𝗹𝗵𝗲𝘀:</b>

• 𝗦𝘂𝗽𝗼𝗿𝘁𝗮 𝗮 𝗴𝗲𝗿𝗮𝗰̧𝗮̃𝗼 𝗱𝗲 𝗰𝗶𝘁𝗮𝗰̧𝗮̃𝗼 𝗮 𝗽𝗮𝗿𝘁𝗶𝗿 𝗱𝗲 𝗺𝗲𝗻𝘀𝗮𝗴𝗲𝗻𝘀 𝘂𝗶́𝗻𝗶𝗰𝗮𝘀 𝗼𝘂 𝗱𝗲 𝘂𝗺𝗮 𝗳𝗮𝗶𝘅𝗮 𝗱𝗲 𝗺𝗲𝗻𝘀𝗮𝗴𝗲𝗻𝘀. 📝
• 𝗢 𝗰𝗼𝗺𝗮𝗻𝗱𝗼 /q 𝗴𝗲𝗿𝗮 𝘂𝗺𝗮 𝗰𝗶𝘁𝗮𝗰̧𝗮̃𝗼 𝗱𝗮 𝗺𝗲𝗻𝘀𝗮𝗴𝗲𝗺 𝗿𝗲𝘀𝗽𝗼𝗻𝗱𝗶𝗱𝗮. 📝
• 𝗢 𝗰𝗼𝗺𝗮𝗻𝗱𝗼 /r 𝗴𝗲𝗿𝗮 𝘂𝗺𝗮 𝗰𝗶𝘁𝗮𝗰̧𝗮̃𝗼 𝗱𝗲 𝘂𝗺𝗮 𝗳𝗮𝗶𝘅𝗮 𝗱𝗲 𝗺𝗲𝗻𝘀𝗮𝗴𝗲𝗻𝘀, 𝗲𝘀𝗽𝗲𝗰𝗶𝗳𝗶𝗰𝗮𝗱𝗮 𝗽𝗼𝗿 𝘂𝗺 𝗻𝘂́𝗺𝗲𝗿𝗼 𝗮𝗽𝗼́𝘀 𝗼 𝗰𝗼𝗺𝗮𝗻𝗱𝗼.
• 𝗔 𝗳𝗮𝗶𝘅𝗮 𝗱𝗲𝘃𝗲 𝗲𝘀𝘁𝗮́𝗿 𝗲𝗻𝘁𝗿𝗲 𝟮 𝗲 𝟭𝟬 𝗺𝗲𝗻𝘀𝗮𝗴𝗲𝗻𝘀. 🔟
• 𝗔 𝗰𝗶𝘁𝗮𝗰̧𝗮̃𝗼 𝗴𝗲𝗿𝗮𝗱𝗮 é 𝗿𝗲𝘁𝗼𝗿𝗻𝗮𝗱𝗮 𝗰𝗼𝗺𝗼 𝘂𝗺 𝘀𝘁𝗶𝗰𝗸𝗲𝗿. 🎨
